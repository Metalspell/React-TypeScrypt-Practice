...
export const myProjects: MyProjectsTypes[] = [
  ...
  },
  {
    ...
    deployed_url: 'https://metalspell.github.io/Simple-chat',
  ...
  {
    name: "Shop Cart",
    description: "Simple shop cart with products from free API",
    image_link: '/images/shopcart.png',
    deployed_url: 'https://metalspell.github.io/Shopcart/',
    github_url: 'https://github.com/Metalspell/Shopcart',
    category: ['ReactJS'],
    key_techs: ["ReactJS"],
  },
];